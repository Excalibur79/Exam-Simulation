...
function ConfirmationModal({ alertOpen, setAlertOpen, ID, text, pushLocation, noteOption, callbackFn, individualObject, purpose, setPurpose, buttonColor }) {
                ...
                <div style={{ padding: '10px', width: screenState.isDesktopView ? '27rem' : '19rem', }} >
                    <div style={{ display: 'flex', justifyContent: 'center' }}>
                        {purpose === 'DELETE' ? <img
                            src={TickMarkRed}
                            alt="confirmation"
                            className={classes.conditionalButtons}
                        />
                            :
                            <img
                                src={TickMarkGreen}
                        ...
                        <DialogTitle
                            ...
                            style={{ textAlign: 'center', color: buttonColor, paddingBottom: "1rem" }}
                        >
                            Confirmation
                        </DialogTitle>
                    </div>
