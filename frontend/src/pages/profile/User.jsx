    ...
    <div className="container">
      <div className="img-area">
         <div className="inner-area">
            ...
            />
            <Label fileselect={fileselect} for='input-file' style={{marginLeft:'7vw',marginTop:'5vw'}}>
      ...
      <div className="presonal-inform">
         ...
         <li><b>Name:</b>Lol pug</li>
         <li><b>Phone:</b>+91 23456 78910</li>
         <li><b>Email:</b>lol@email.com</li>
         <li><b>Date of Birth:</b> 6 January 1987</li>
     <li><b>Address:</b>Inox Box 1546, Lorem.</li>
            <li><b>Subject:</b>Epsum</li>
                         </ul>
           </div>
           <Button variant="outlined" size="large" onClick={handleOpen}>EDIT</Button>
           <Modal
        open={open}
        onClose={handleClose}
